...
async function main() {
  ...
  // Créer 10 clients
  console.log("👤 Création de 10 clients...");
  const clientsData = [
    {
      firstName: "Jean",
      lastName: "Dupont",
  ...
  console.log("🏢 Création de 10 prestataires...");
  ...
  console.log(`🏢 10 prestataires créés`);
  console.log(`⚙️ 1 admin créé`);
  console.log(`🛠️ ${servicesData.length} services créés`);

  console.log("\n🔑 Comptes de test :");
  console.log("👤 Clients : client1@test.fr à client10@test.fr / Client123");
  console.log(
    "🏢 Prestataires : voir emails dans les organisations / Prestataire123"
  );
